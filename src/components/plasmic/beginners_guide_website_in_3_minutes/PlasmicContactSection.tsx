...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: afbHaOgF2DSq/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___3FXjh)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__mUlm6)}>
          <a
