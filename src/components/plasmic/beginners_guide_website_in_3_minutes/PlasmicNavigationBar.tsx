...
import sty from "./PlasmicNavigationBar.module.css"; // plasmic-import: 6SnOwwEGnja9/css
  ...
  return (
    <NavigationBar
      ...
      closeButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__kkl7N)}
          displayHeight={"auto"}
      ...
      openButton={
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__rz3N5)}
          displayHeight={"auto"}
          displayMaxHeight={"none"}
          displayMaxWidth={"none"}
          displayMinHeight={"0"}
