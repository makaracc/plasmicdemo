...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: 3WG5jolSY8SI/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns___4ALh0)}>
        <div className={classNames(projectcss.all, sty.column__k0IZ4)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__ruPyP)}>
          <div className={classNames(projectcss.all, sty.columns__a2Lz2)}>
            <div className={classNames(projectcss.all, sty.column__zcazC)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cCuyK)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column___0A8Vz)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bYzac)}>
                {renderPlasmicSlot({
